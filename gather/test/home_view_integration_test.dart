...
import 'package:firebase_auth/firebase_auth.dart'; // Necessário para o tipo User?

import 'package:gather/views/homeView.dart';
import 'package:gather/viewmodels/authViewModel.dart';

// 1. Criamos um "Dublê" (Mock) do seu ViewModel que não conecta no Firebase
...
void main() {
  group('Testes de Integração - Interface e Estado', () {
    ...
    testWidgets('Deve integrar o clique do botão e alternar entre Login e Cadastro na HomeView', (WidgetTester tester) async {
