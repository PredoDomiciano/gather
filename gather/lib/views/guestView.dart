...
class _GuestViewState extends State<GuestView> {
  ...
  // Lista para guardar as restrições selecionadas pelo usuário
  List<String> _selectedRestrictions = [];

  // Lista com todas as opções (Baseado no seu design)
  final List<Map<String, dynamic>> _restrictionOptions = [
    ...
    {'label': 'Sem Glúten', 'icon': Icons.grass_outlined}, // Aproximado para trigo
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // LÓGICA DE TROCA DE TELA: Se não tem evento, pede o código. Se tem, mostra o formulário.
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'DIGITE O CÓDIGO (EX: BOLO24)',
  ...
  // =========================================
  // PASSO 2: FORMULÁRIO DE RESTRIÇÕES
  // =========================================
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF00D1FF), // Ciano
          ...
          TextField(
            ...
            maxLines: 4,
            decoration: InputDecoration(
              hintText: 'Outras alergias ou preferências que devemos saber?',
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: const BorderSide(color: Colors.grey, width: 0.5),
              ),
            ...
            onPressed: viewModel.isLoading
                ...
                : () async {
                    bool success = await viewModel.submitPreferences(
                      name: _nameController.text, // A trava de vazio está no ViewModel!
                      restrictions: _selectedRestrictions,
                      notes: _notesController.text,
                    );
                    
                    if (success && mounted) {
                      // Se deu certo, mostra um aviso de sucesso e volta pro login
                      ...
                      Navigator.pop(context); // Volta pro início
                    }
                  },
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFF161730),
